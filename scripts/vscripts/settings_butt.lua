BUTTINGS = {
	...
	GOLD_GAIN_PERCENTAGE = 120,         -- (default = 100) factor for gold income
	GOLD_PER_MINUTE = 200,               -- (default =  90) passive gold
	RESPAWN_TIME_PERCENTAGE = 80,      -- (default = 100) factor for respawn time
	XP_GAIN_PERCENTAGE = 120,           -- (default = 100) factor for xp income
	...
	XP_PER_MINUTE = 100,                  -- (normal dota = 0) everyone gets passive experience (like the passive gold)
